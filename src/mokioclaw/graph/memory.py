...
def build_layered_memory(state: dict[str, Any], *, node: str = "graph") -> dict[str, Any]:
    ...
    working_memory = {
        ...
        "research_notes": _short_text(state.get("research_notes", ""), MAX_TEXT_CHARS.get("research_notes", 1600)),
        "sources": state.get("sources", []),
        "agent_handoffs": state.get("agent_handoffs", []),
        "code_agent_summary": _short_text(state.get("code_agent_summary", ""), MAX_TEXT_CHARS.get("code_agent_summary", 1000)),
